  ...
  return (
    <div className={s.page}>
      ...
      <div className={s.banner}>
        ...
        <div className={s.subtitle}>Découvrez notre sélection de véhicules vérifiés et garantis !</div>
      </div>

      <div className={s.newOffers}>
        <div className={s.titleNewOffers}>Nouveau : Location longue durée !</div>
